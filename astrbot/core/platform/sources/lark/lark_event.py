...
from astrbot.core.message.components import File, Json, Mention, Plain, Record, Video
    ...
    async def get_group(
        ...
        **kwargs,
        ...
        try:
            ...
            response = await self._bot.im.v1.chat.aget(request)
        ...
        try:
            while True:
                ...
                members_response = await self._bot.im.v1.chat_members.aget(
