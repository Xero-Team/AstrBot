"""Table models for the main SQLite database.

This package entry point re-exports table=True models. Schema registration is
owned by ``astrbot.core.db.po.registry.import_all_models``.
"""
