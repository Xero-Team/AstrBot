...
export type CodingCliSwitchRequest = {
  cli: 'claude_code' | 'codex';
  provider_id: string;
};
...
export type CodingCli = 'claude_code' | 'codex';
...
export type GetCodingCliGlobalConfigData = {
  body?: never;
  path?: never;
  query?: never;
...
export type GetCodingCliGlobalConfigResponses = {
  /**
   * Standard AstrBot success response
   */
  200: SuccessEnvelope;
...
export type GetCodingCliGlobalConfigResponse =
  GetCodingCliGlobalConfigResponses[keyof GetCodingCliGlobalConfigResponses];

export type SwitchCodingCliProviderData = {
  body: CodingCliSwitchRequest;
  path?: never;
  query?: never;
  url: '/api/v1/coding-cli/global-config';
};

export type SwitchCodingCliProviderResponses = {
  /**
   * Standard AstrBot success response
   */
  200: SuccessEnvelope;
...
export type SwitchCodingCliProviderResponse =
  SwitchCodingCliProviderResponses[keyof SwitchCodingCliProviderResponses];

export type RemoveCodingCliGlobalConfigData = {
  body?: never;
  path: {
    cli: 'claude_code' | 'codex';
  };
...
export type RemoveCodingCliGlobalConfigResponses = {
  /**
   * Standard AstrBot success response
   */
  200: SuccessEnvelope;
...
export type RemoveCodingCliGlobalConfigResponse =
  RemoveCodingCliGlobalConfigResponses[keyof RemoveCodingCliGlobalConfigResponses];
