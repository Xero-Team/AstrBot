"""Opt-in rule classifier extracted from the BTW prototype for evaluation."""
...
from .types import TaskType, is_work_loop_enabled
...
class TaskClassifier:
    ...
    This experimental candidate preserves the prototype keyword rules.
    Classification is opt-in on every
