            ...
            "provider": {
                ...
                "config_template": {
                    ...
                    "IkunCode": {
                        ...
                        "key": [],
                        "timeout": 120,
                        "api_base": "https://api.ikuncode.cc/v1",
                        "proxy_mode": "inherit",
                        "proxy_url": "",
                        "custom_headers": {},
                    },
                ...
                "items": {
                    ...
                    "variables": {
                        ...
                        "type": "object",
                        "items": {},
                        "hint": "可选。工作流固定输入变量，将会作为工作流的输入。也可以在对话时使用 /variable set 指令动态设置变量。如果变量名冲突，优先使用动态设置的变量。",
                        "invisible": True,
                    },
                    "dashscope_app_type": {
                        "description": "应用类型",
            ...
            "admission": {
                ...
                "items": {
                    ...
                    "admission.unlisted_senders": {
                        ...
                        "options": ["allow", "deny"],
                        "labels": ["允许", "拒绝"],
                        "hint": "allow 放行没有覆盖的发送者。deny 只放行已有 blocked 或 llm_enabled 覆盖的发送者。Dashboard 自定义规则的发送者目标和 /user block、/user unblock、/user llm on|off 写入同一份覆盖。",
                    },
                },
            },
            "rate_limit": {
