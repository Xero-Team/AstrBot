...
Package metadata requires Python 3.14 or later. The checkout pins Python 3.14.7 in `.python-version`; `uv` can download that version when its managed-Python support is enabled.
