...
| `napcat`                  | Image, audio, video, file                 | OneBot/NapCat segments; outbound images and audio are `base64://` so NapCat need not read AstrBot local paths; native content declared by kind |
