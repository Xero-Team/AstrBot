...
| `napcat`                  | Image, audio, video, file                 | OneBot/NapCat segments; local/file:// images and audio are encoded as `base64://`; HTTP and existing base64 pass through; AstrBot paths are never forwarded; native content declared by kind |
