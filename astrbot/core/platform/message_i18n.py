...
LOCALES: dict[str, dict[str, str]] = {
    "zh-CN": {
        ...
        "astrbot.msg.forward": "[转发消息]",
        "astrbot.msg.forward_card.title": "转发消息",
        "astrbot.msg.forward_card.footer": "共 {count} 条消息",
    ...
    "en-US": {
        ...
        "astrbot.msg.forward": "[Forwarded messages]",
        "astrbot.msg.forward_card.title": "Forwarded messages",
        "astrbot.msg.forward_card.footer": "{count} messages",
